...
OPTIONAL_CONFIG_DEFAULTS: dict[str, Any] = {
    ...
    "import_erp_pi_register_default_from_input_selector": 'input[aria-label="From Date :"]',
    "import_erp_pi_register_default_to_input_selector": 'input[aria-label="To Date :"]',
    "import_erp_pi_register_default_buyer_input_selector": 'input[aria-label="Buyer Name:"]',
    ...
    "import_erp_pi_register_submit_selector": '[aria-label="Submit"]',
    "import_erp_pi_register_post_submit_wait_selector": ".dxrd-preview-export-to:not(.dx-state-disabled)",
    "import_erp_pi_register_download_menu_selector": ".dxrd-preview-export-to",
    "import_erp_pi_register_download_format_selector": '.dxrd-preview-export-item-text:text-is("CSV")',
    "import_erp_login_url": "",
    "import_erp_username_selector": "#UserID",
    "import_erp_password_selector": "#PasswordH",
    "import_erp_login_submit_selector": "#btnSubmit",
