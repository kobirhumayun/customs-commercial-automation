...
INTEGER_KEYS = {
    ...
    "import_erp_pi_register_default_lookback_days",
    "import_erp_pi_register_default_from_input_index",
    "import_erp_pi_register_default_to_input_index",
    "import_erp_pi_register_default_buyer_input_index",
...
OPTIONAL_CONFIG_DEFAULTS: dict[str, Any] = {
    ...
    "import_erp_pi_register_default_lookback_days": 90,
    "import_erp_pi_register_default_from_input_selector": ".dx-texteditor-input",
    "import_erp_pi_register_default_to_input_selector": ".dx-texteditor-input",
    "import_erp_pi_register_default_buyer_input_selector": ".dx-texteditor-input",
    "import_erp_pi_register_default_from_input_index": 2,
    "import_erp_pi_register_default_to_input_index": 3,
    "import_erp_pi_register_default_buyer_input_index": 4,
    "import_erp_pi_register_default_buyer_name": "PIONEER DENIM LIMITED",
    "import_erp_pi_register_submit_selector": 'role=button[name="Submit"]',
    "import_erp_pi_register_post_submit_wait_selector": ".dx-menu-item-popout",
    "import_erp_pi_register_download_menu_selector": ".dx-menu-item-popout",
    "import_erp_pi_register_download_format_selector": '.dxrd-preview-export-item-text:text-is("CSV")',
    "import_erp_login_url": "",
    "import_erp_username_selector": 'input[type="text"]',
    "import_erp_password_selector": 'input[type="password"]',
    "import_erp_login_submit_selector": 'button[type="submit"], input[type="submit"]',
    "import_erp_post_login_wait_selector": "",
    ...
    sorted(
        {
            *OPTIONAL_CONFIG_DEFAULTS.keys(),
            ...
            "import_erp_username",
            "import_erp_password",
            "import_erp_username_selector",
            "import_erp_password_selector",
            "import_erp_login_submit_selector",
            "import_erp_post_login_wait_selector",
            "import_erp_pi_register_fill_values",
            "import_erp_pi_register_default_lookback_days",
            "import_erp_pi_register_default_from_input_selector",
            "import_erp_pi_register_default_to_input_selector",
            "import_erp_pi_register_default_buyer_input_selector",
            "import_erp_pi_register_default_from_input_index",
            "import_erp_pi_register_default_to_input_index",
            "import_erp_pi_register_default_buyer_input_index",
            "import_erp_pi_register_default_buyer_name",
            "import_erp_pi_register_submit_selector",
            "import_erp_pi_register_post_submit_wait_selector",
            "import_erp_pi_register_download_menu_selector",
            "import_erp_pi_register_download_format_selector",
            "erp_username",
            "erp_password",
...
def _validate_startup_contract(descriptor: WorkflowDescriptor, values: dict[str, Any]) -> None:
    ...
    _validate_non_negative_int(
        values=values,
        key="import_erp_pi_register_default_lookback_days",
    )
    _validate_non_negative_int(
        values=values,
        key="import_erp_pi_register_default_from_input_index",
    )
    _validate_non_negative_int(
        values=values,
        key="import_erp_pi_register_default_to_input_index",
    )
    _validate_non_negative_int(
        values=values,
        key="import_erp_pi_register_default_buyer_input_index",
    )
    _validate_positive_int(
        values=values,
