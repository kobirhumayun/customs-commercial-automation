...
def render_import_btb_lc_html_report(report: dict[str, object]) -> str:
    ...
    return (
        ...
        "        <thead><tr><th>Decision</th><th>Filename</th><th>Bank</th><th>Raw Extracted Values</th><th>BTB LC</th><th>BTB LC Issue Date</th><th>BTB Value</th><th>Currency</th><th>Seller PI Number(s)</th><th>ERP PI Amount</th><th>Calculated Quantity (Kgs)</th><th>Related Export LC</th><th>Candidate Evidence</th><th>SL.No.</th><th>Disposition</th><th>Decision Reasons</th><th>Warnings</th><th>Discrepancies</th></tr></thead>\n"
        "        <tbody>\n"
        f"{rows_html}\n"
        "        </tbody>\n"
        "      </table>\n"
