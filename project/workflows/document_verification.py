...
def _saved_document_from_payload(payload: dict[str, Any], *, mail_id: str) -> SavedDocument:
    return SavedDocument(
        ...
        extracted_document_number=_optional_str(payload.get("extracted_document_number")),
        extracted_document_number_confidence=_optional_float(payload.get("extracted_document_number_confidence")),
        extracted_document_date=_optional_str(payload.get("extracted_document_date")),
        extracted_document_date_confidence=_optional_float(payload.get("extracted_document_date_confidence")),
        extracted_quantity=_optional_str(payload.get("extracted_quantity")),
        extracted_quantity_unit=_optional_str(payload.get("extracted_quantity_unit")),
        ...
        extracted_document_number_provenance=_optional_dict(payload.get("extracted_document_number_provenance")),
        extracted_document_date_provenance=_optional_dict(payload.get("extracted_document_date_provenance")),
        extracted_quantity_provenance=_optional_dict(payload.get("extracted_quantity_provenance")),
